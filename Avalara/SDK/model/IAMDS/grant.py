...
class Grant(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'type': (str,),  # noqa: E501
            'role': (Reference,),  # noqa: E501
            'id': (str,),  # noqa: E501
            'description': (str,),  # noqa: E501
            'rules': ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}],),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            display_name (str): Name of the Grant
            system (Reference):
            type (str): Determines the grant ownership
            role (Reference):
            ...
            description (str): Description of the grant, used for display purposes. [optional]  # noqa: E501
            rules ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): Defines the conditions associated with permissions in the role. [optional]  # noqa: E501
