...
class Group(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'members': ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}],),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            display_name (str): Name of the group, unique within the Tenant
            tenant (Reference):
            ...
            external_id (str): Identifier for the group in external systems (clients). The external systems manage this. [optional]  # noqa: E501
            members ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): List of members belonging to the group. [optional]  # noqa: E501
            grants ([Reference]): List of grants assigned to the Group. [optional]  # noqa: E501
