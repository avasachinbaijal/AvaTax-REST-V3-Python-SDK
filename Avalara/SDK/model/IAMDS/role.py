...
class Role(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            display_name (str): Name of the Role
            system (Reference):
            type (str): Determines the role ownership
            permissions ([str]): List of associated permissions, identified by the permission name
