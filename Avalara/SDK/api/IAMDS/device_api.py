...
from Avalara.SDK.model.IAMDS.device import Device
...
class DeviceApi(object):
    ...
    def __set_configuration(self, api_client):
        ...
        self.add_grant_to_device_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'OAuth'
                ],
                'endpoint_path': '/devices/{device-id}/grants/{grant-id}',
                'operation_id': 'add_grant_to_device',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
        ...
        self.delete_device_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/devices/{device-id}',
        ...
        self.get_device_groups_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/devices/{device-id}/groups',
        ...
        self.list_device_grants_endpoint = _Endpoint(
            settings={
                'response_type': (DeviceList,),
                'auth': [
                    'OAuth'
                ],
                'endpoint_path': '/devices/{device-id}/grants',
                'operation_id': 'list_device_grants',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.remove_grant_from_device_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'OAuth'
                ...
                'endpoint_path': '/devices/{device-id}/grants/{grant-id}',
                'operation_id': 'remove_grant_from_device',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.replace_device_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'OAuth'
    ...
    def add_grant_to_device(
        self,
        device_id,
        grant_id,
        **kwargs
    ):
        """Add a grant to a device.  # noqa: E501

        Adds a grant to a device.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.add_grant_to_device(device_id, grant_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['grant_id'] = \
            grant_id
        return self.add_grant_to_device_endpoint.call_with_http_info(**kwargs)
    ...
    def create_device(
        ...
        **kwargs
        ...
        The response contains the same object as posted and fills in the newly assigned device ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def delete_device(
        ...
        **kwargs
        ...
        Deletes the device by ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_device(
        ...
        **kwargs
        ...
        Retrieves the specified device.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_device_groups(
        ...
        **kwargs
        ...
        """List all groups for the device.  # noqa: E501

        Retrieve a list of all groups a device belongs to which the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.  Filterable properties:   * displayName * grants/identifier   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_device_groups(device_id, async_req=True)
        >>> result = thread.get()
    ...
    def list_device_grants(
        ...
        **kwargs
        ...
        """List all grants for the device.  # noqa: E501

        Retrieve a list of all grants a device belongs to which the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.  Filterable properties:   * displayName * system/identifier * type * role/identifier  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_device_grants(device_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['device_id'] = \
            device_id
        return self.list_device_grants_endpoint.call_with_http_info(**kwargs)

    def list_devices(
        self,
        **kwargs
    ):
        """List all devices which the user has access to.  # noqa: E501

        Retrieve a list of all devices the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.  Filterable properties:   * displayName * tenant/identifier * active * grants/identifier * groups/identifier  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def patch_device(
        ...
        **kwargs
        ...
        """Update only the fields in the body for the device.  # noqa: E501

        Updates only the fields passed in for the specified device.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def remove_grant_from_device(
        self,
        device_id,
        grant_id,
        **kwargs
    ):
        """Remove a grant from a device.  # noqa: E501

        Removes a grant from a device.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.remove_grant_from_device(device_id, grant_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['grant_id'] = \
            grant_id
        return self.remove_grant_from_device_endpoint.call_with_http_info(**kwargs)
    ...
    def replace_device(
        ...
        **kwargs
        ...
        """Update all fields on a device.  # noqa: E501

        Replaces the specified device with the device in the body.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.replace_device(device_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['device_id'] = \
            device_id
        return self.replace_device_endpoint.call_with_http_info(**kwargs)
