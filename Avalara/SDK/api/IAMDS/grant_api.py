...
from Avalara.SDK.model.IAMDS.grant import Grant
...
class GrantApi(object):
    ...
    def __set_configuration(self, api_client):
        ...
        self.create_grant_endpoint = _Endpoint(
            settings={
                'response_type': (Grant,),
                'auth': [
                    'OAuth'
                ],
                'endpoint_path': '/grants',
        ...
        self.delete_grant_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'OAuth'
                ],
                'endpoint_path': '/grants/{grant-id}',
        ...
        self.get_grant_endpoint = _Endpoint(
            settings={
                'response_type': (Grant,),
                'auth': [
                    'OAuth'
        ...
        self.list_grants_endpoint = _Endpoint(
            settings={
        ...
        self.patch_grant_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'OAuth'
        ...
        self.replace_grant_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'OAuth'
    ...
    def create_grant(
        ...
        **kwargs
        ...
        The response contains the same object as posted and fills in the newly assigned grant ID.  # noqa: E501
        ...
        return self.create_grant_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_grant(
        ...
        **kwargs
        ...
        Deletes the specified grant.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['grant_id'] = \
            grant_id
        return self.delete_grant_endpoint.call_with_http_info(**kwargs)
    ...
    def get_grant(
        ...
        **kwargs
        ...
        """Retrieve a grant.  # noqa: E501

        Retrieves a grant based on its ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['grant_id'] = \
            grant_id
        return self.get_grant_endpoint.call_with_http_info(**kwargs)

    def list_grants(
        self,
        **kwargs
    ):
        """Retrieve all grants the current user has access to.  # noqa: E501

        Retrieve a list of all grants the authenticated user has access to. This list is paged, returning no more than 1000 items at a time.  Filterable properties:  * displayName * system/identifier * type * role/identifier  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_grants_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_grant(
        ...
        **kwargs
        ...
        """Update only the fields within the body on the grant.  # noqa: E501

        Updates only the fields passed in the body.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_grant(grant_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['grant_id'] = \
            grant_id
        return self.patch_grant_endpoint.call_with_http_info(**kwargs)
    ...
    def replace_grant(
        ...
        **kwargs
        ...
        """Update all fields on a grant.  # noqa: E501

        Replaces the specified grant with the grant in the body.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.replace_grant(grant_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['grant_id'] = \
            grant_id
        return self.replace_grant_endpoint.call_with_http_info(**kwargs)
