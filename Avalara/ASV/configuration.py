...
conf = Avalara.ASV.Configuration(
    ...
    def __init__(self, 
        ...
        if environment:
            if environment.lower() == 'sandbox':
                self._base_path = 'https://sandbox-rest.avatax.com'
            elif environment.lower() == 'production':
                self._base_path = 'https://rest.avatax.com'
            else:
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("Avalara.ASV")
