...
If the OpenAPI document is large, imports in AvalaraTest.SDK.apis and AvalaraTest.SDK.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- `from AvalaraTest.SDK.api.default_api import DefaultApi`
- `from AvalaraTest.SDK.model.pet import Pet`
...
import AvalaraTest.SDK
from AvalaraTest.SDK.apis import *
from AvalaraTest.SDK.models import *
```
